...
import { l as cn, m as cva } from "./Select-1pGyLj6A.mjs";
...
const Badge = ({ className, variant, ...props }) => jsxRuntimeExports.jsx("div", { className: cn(badgeVariants({ variant }), className), ...props });
export {
  Badge as B
};
